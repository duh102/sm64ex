...
// Consumes id SM64AP_ID_OFFSET + (250 -> 399)
#define SM64AP_LOCATIONID_BASE_MAX_COIN (SM64AP_ID_OFFSET+250)
#define SM64AP_LOCATIONID_MAX_COIN(x, y) (SM64AP_LOCATIONID_BASE_MAX_COIN+(10*(x))+(((y)/10)-1))

#define SM64AP_NUM_LOCS 399
...
AP_EXTERN_C bool SM64AP_ShouldCheckMaxCoins();
